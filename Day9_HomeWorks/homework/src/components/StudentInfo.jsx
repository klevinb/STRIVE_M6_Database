    ...
    return (
      <>
        {this.props.students.map((student) => (
          <Col key={student.studentid} className='mb-3'>
            <Card
              style={{
                width: "18rem",
                display: "flex",
            ...
            >
              ...
              <Card.Body>
                ...
                <div className='d-flex justify-content-between'>
                  <Button
                    variant='info'
                    onClick={() => this.goToProjectPage(student.studentid)}
                  >
                    Projects
                  </Button>
                  <Button
                    variant='danger'
                    onClick={() => this.props.deleteStudent(student.studentid)}
                  >
                    Delete
                  </Button>
                  <Button
                    variant='warning'
                    onClick={() =>
                      this.props.fetchStudentData(student.studentid)
                    }
                  >
                    Edit
                  </Button>
